...
const SCHEDULE_DATA = {
  ...
  day3: {
    ...
    route: [
      ...
      { time: '09:20', title: '購票', place: '城山港 (Seongsan Port)', note: '09:20 - 09:50', link: 'https://naver.me/5KqVxB8K', desc: '辦理購票與登船手續。', tips: ['必備：護照', '國際駕照 (若要租車)'], image: '/images/day3_02_ticket.jpg' },
  ...
  day4: {
    ...
    route: [
      ...
      { time: '07:30', title: '抵達', place: '御里牧停車場 (Eorimok)', note: '07:30', link: 'https://naver.me/G7CYrjDW', desc: '準備登山裝備，做暖身操。', tips: ['穿好冰爪'], image: '/images/day4_02_eorimok.jpg' },
  ...
  day5: {
    ...
    route: [
      ...
      { time: '10:20', title: '貝果', place: '倫敦貝果博物館 濟州', note: '10:20 - 11:30', link: 'https://naver.me/5ZSKL4vw', desc: '超人氣排隊名店。', tips: ['建議先抽號碼牌', '旁邊有 Cafe Layered'], image: '/images/day5_02_bagel.jpg' },
      { time: '11:30', title: '海灘', place: '月汀里海灘 (Woljeongri)', note: '11:30 - 12:30', link: 'https://naver.me/xAAnOQdr', desc: '在海岸線上的咖啡廳休息或拍照。', tips: ['彩色椅子打卡點'], image: '/images/day5_03_beach.jpg' },
      { time: '12:30', title: '午餐', place: '東部海岸線特色餐廳', note: '12:30 - 13:30', link: '', desc: '享用當地美食。', tips: [], image: '/images/day5_04_lunch.jpg' },
      { time: '13:30', title: '文化', place: '濟州海女博物館 (Guide)', note: '13:30 - 14:30', link: '', 
        ...
        tips: ['週一休館', '有影片導覽'], 
        image: '/images/day5_05_haenyeo.jpg' 
      },
      { time: '14:30', title: '活動', place: '金寧迷宮公園 (可選)', note: '14:30 - 15:30', link: 'https://naver.me/II4YnNsE', 
        ...
        tips: ['注意時間控制', '有貓咪出沒'], 
        image: '/images/day5_06_maze.jpg' 
      },
      { time: '16:30', title: '購物', place: '樂天免稅店 濟州店', note: '16:30 - 18:30', link: 'https://naver.me/5noaH784', desc: '最後購物衝刺，或回到蓮洞商圈。', tips: ['記得帶護照'], image: '/images/day5_07_dutyfree.jpg' },
      { time: '18:30', title: '晚餐', place: '市區吃晚餐', note: '18:30 - 20:00', link: '', desc: '享用在濟州的最後一餐。', tips: [], image: '/images/day5_08_dinner.jpg' },
      { time: '20:00', title: '還車', place: '樂天租車', note: '20:00 - 21:00', link: 'https://naver.me/FqZqommG', desc: '還車並搭乘接駁車前往機場。', tips: ['加滿油', '預留安檢時間'], image: '/images/day5_09_return.jpg' },
      { time: '21:00', title: '返程', place: '濟州國際機場', note: '21:00 抵達機場', link: 'https://map.naver.com/p/search/제주국제공항', desc: '22:15 起飛，帶著滿滿回憶返家。', tips: ['Safe Flight!'], image: '/images/day5_10_airport.jpg' }
    ]
  }
};
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto px-6 py-12 space-y-20">
      ...
      <section>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6">
          ...
          {/* 回程 */}
          <div className="bg-white p-6 rounded-sm shadow-sm border border-[#E6E4DD]">
            <div className="mb-4 w-full aspect-[1.97] bg-gray-100 overflow-hidden rounded relative"><img src={data.flights[1].image} className="w-full h-full object-cover" alt="Inbound"/></div>
          ...
          <div className="bg-white p-6 rounded-sm shadow-sm border border-[#E6E4DD]">
            ...
            <div className="space-y-4 text-xs text-[#666]">
              {data.baggageInfo.map((info, i) => (
                <div key={i} className="border-b border-[#F0F0F0] pb-2 mb-2 last:border-0">
                  <span className="font-bold block text-[#444] text-sm mb-1">{info.type}</span>
                  <span className="leading-5">{info.desc}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section>
        ...
        <div className="bg-white p-6 rounded-sm shadow-sm border border-[#E6E4DD] mb-6">
          ...
          {/* 修改三：退稅 READ MORE 連結 (酒紅底塊按鈕) */}
          <div className="mt-6 flex justify-end">
             <a href="https://djbcard.com/koreataxrefund/" target="_blank" rel="noreferrer" className="flex items-center justify-center bg-wine text-white px-6 py-3 rounded hover:bg-coffee transition-colors shadow-lg shadow-wine/20 gap-2 text-xs tracking-widest font-bold">
      ...
      <div className="flex overflow-x-auto space-x-4 pb-6 px-2 scrollbar-hide snap-x">
        {items.map((item, idx) => (
          <div key={idx} onClick={() => onItemClick(item)} className="flex-shrink-0 w-64 bg-white border border-[#E6E4DD] p-5 rounded snap-center hover:shadow-md transition-shadow cursor-pointer group">
            ...
            {/* 修改四：查看更多改為 READ MORE */}
            <span className="text-xs text-[#2C2C2C] border border-[#DDD] px-3 py-1.5 rounded group-hover:bg-wine group-hover:text-white group-hover:border-wine transition-colors block text-center tracking-widest font-bold">READ MORE</span>
          </div>
        ))}
